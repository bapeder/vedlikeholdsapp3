...
def send_email(to_email, subject, body):
    try:
        ...
        st.error("SMTP-autentisering feilet. Sjekk at SMTP_EMAIL og SMTP_PASSWORD er korrekt, og at App Password er gyldig.")
        return False
    except smtplib.SMTPException as e:
        st.error(f"SMTP-feil: {str(e)}. Sjekk Gmail-innstillinger eller nettverkstilkobling.")
        return False
    except Exception as e:
        st.error(f"Kunne ikke sende e-post: {str(e)}. Kontakt administrator.")
        return False
...
if page == "Hjem":
    ...
    if not user_role.empty and user_role["role"].iloc[0] == "Administrator":
        ...
        if CALENDAR_AVAILABLE:
            ...
            try:
                # Oppdatert for streamlit-calendar==0.4.0
